...
import { intersectsRect, type Rect } from '../../src/hooks/useRubberBand';
...
describe('intersectsRect', () => {
  ...
  it('handles reversed coordinates (endX < startX — drag right-to-left)', () => {
    // Caller normalizes, but intersectsRect itself should handle any orientation
    // where left < right — verify it works with normalized rect
